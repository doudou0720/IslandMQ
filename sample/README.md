...
> **重要提醒**: 以下示例代码中使用的是默认端口号（5555 和 5556）。默认端口为 5555 和 5556；请在示例代码中暴露可配置的端口参数/常量（如 DEFAULT_PORT_1/DEFAULT_PORT_2 或配置对象）以便修改，实际使用时请根据 IslandMQ 插件的配置确认并修改为您对应的端口号。
